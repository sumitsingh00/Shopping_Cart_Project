...
import { useDispatch, useSelector } from "react-redux";// importing the function and varibale's from redux store
import {add ,remove} from "../redux/Slices/CartSlice";// importing the function  from redux store
